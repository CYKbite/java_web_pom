...
public class MPGenerator {
    ...
    public static void main(String[] args) {
        // 1.数据源配置
        DataSourceConfig dataSourceConfig = new DataSourceConfig.Builder("jdbc:mysql://localhost:3306/mall","root","123456").build();
        ...
        // 作者
        globalConfigBuilder.author("CYK");
        // 结束时是否打开文件夹
        ...
        packageConfigBuilder.parent("com.situ.mall");           //项目包名
